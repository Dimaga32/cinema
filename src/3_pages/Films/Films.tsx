...
export default function FilmsContent(): ReactNode {
	...
	const search :string= useFiltersFilmsSelector(state => state.filtersFilms.search);
	const genre: TypeGenre = useFiltersFilmsSelector(state => state.filtersFilms.genre);
	const rating:number = useFiltersFilmsSelector(state => state.filtersFilms.rating);
